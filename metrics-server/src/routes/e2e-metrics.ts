 ...
 */
router.post('/e2e-tests', authenticate, async (req: Request, res: Response): Promise<void> => {
  try {
 ...
 */
router.get('/e2e-tests', authenticate, async (req: Request, res: Response): Promise<void> => {
  try {
