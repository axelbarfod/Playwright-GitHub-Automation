 ...
 */
router.post('/api-tests', authenticate, async (req: Request, res: Response): Promise<void> => {
  try {
 ...
 */
router.get('/api-tests', authenticate, async (req: Request, res: Response): Promise<void> => {
  try {
